       ...
       <Row>
        <Col md={0} lg={1} />
            <Col lg={3}className="d-flex flex-column pr-4 bg-grad-pod">
                <p className="display-5 text-center my-auto strong p-5 text-light justify-content-center mr-5 align-items-center">PODCASTS</p>
        ...
        <Col md={12} lg={8}>
          ...
          <Slider {...options}>
            {pods.map((pod) => (
              <div className="p-5" style={{border:'1px solid green'}}>
                <iframe
                  className="pod"
                  src={pod.link}
